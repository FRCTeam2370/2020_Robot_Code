...
public final class Constants {
    public static int DriveMotorLeftFront = 4;
    public static int DriveMotorLeftBack = 3;
    public static int DriveMotorRightFront = 2;
    public static int DriveMotorRightBack = 1;
